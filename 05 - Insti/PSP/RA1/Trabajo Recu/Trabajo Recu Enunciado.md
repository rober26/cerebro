Crear un sistema de reservas de vuelos en Java que permita a los usuarios buscar vuelos disponibles, seleccionar asientos, realizar reservas y gestionar sus itinerarios de viaje.
